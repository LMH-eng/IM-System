...
#define DEF_HEARTBEAT  (DEF_BASE_PACKAGETYPE+10)
#define DEF_HEARTBEAT_INTERVAL  30000
#define DEF_HEARTBEAT_TIMEOUT   90000
...
struct PROT_REGISTER_INFO_RS {
    packageType packType;
    int result;
    PROT_REGISTER_INFO_RS():packType(DEF_REGISTER_RS){}
...
struct PROT_LOGIN_RS {
    ...
    int result;
    int userId;
    PROT_LOGIN_RS():packType(DEF_LOGIN_RS), result(0), userId(0) {}
    PROT_LOGIN_RS(int _result, int _userId):packType(DEF_LOGIN_RS), result(_result), userId(_userId){}
};
...
struct PROT_FRIEND_INFO {
    ...
    PROT_FRIEND_INFO():packType(DEF_FRIEND_INFO){}
...
struct PROT_CHATMSG_RS {
    ...
    int destid;
    int result;
    PROT_CHATMSG_RS() : packType(DEF_CHATMSG_RS) {};
...
struct PROT_FRIEND_OFFLINE {
    packageType packType;
    int myid;
    PROT_FRIEND_OFFLINE() :packType(DEF_FRIEND_OFFLINE){}
